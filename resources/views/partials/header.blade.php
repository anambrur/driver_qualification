                        ...
                        <ul class="flex flex-col gap-1 border-b border-gray-200 pt-4 pb-3 dark:border-gray-800">
                            <li>
                                @if ($authUser->company && $authUser->company->id)
                                    <a href="{{ route('admin.settings.company.edit', $authUser->company->id) }}"
                                ...
                                @else
                                    <span
                                        class="group text-theme-sm flex items-center gap-3 rounded-lg px-3 py-2 font-medium text-gray-400 cursor-not-allowed dark:text-gray-600">
                                        <svg class="fill-gray-400 dark:fill-gray-600" width="24" height="24"

...
@section('title', 'Driver License Upload | DOT Driver Qualification')
            ...
            <div class="p-4 mx-auto max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-9">
                        ...
                        <form action="{{ route('public.application.store.step2', ['slug' => $company->slug]) }}"
                                ...
                                <div class="p-5 sm:p-6">
                                    <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                                        ...
                                        <div>
                                            ...
                                            @if ($driver_document && $driver_document->license_front)
                                                <div class="mb-4">
                                                    <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Current Front
                                                        Image:
                                                    </p>
                                                    ...
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                            <label for="license_front"
                                                                ...
                                                                <input id="license_front" name="license_front"
                                                    ...
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                            <label for="license_back"
                                                                ...
                                                                <input id="license_back" name="license_back"
                                                                    type="file" class="sr-only" accept="image/*"
                                    ...
                                    @if ($driver->licenses->isNotEmpty())
                                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                                            <h4 class="text-lg font-medium text-gray-800 dark:text-white/90 mb-4">Current
                                                License
                                                Information</h4>
                            ...
                            <div
                                ...
                                @if ($isEditMode)
                                    <a href="{{ route('public.application.step1', ['id' => $driver_id]) }}"

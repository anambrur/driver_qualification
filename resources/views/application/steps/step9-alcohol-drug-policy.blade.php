...
@section('title', 'Alcohol & Drug Testing Policy | DOT Driver Qualification')
            ...
            <div class="p-4 mx-auto max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-9">
                        ...
                        <form action="{{ route('public.application.store.step9', ['slug' => $company->slug]) }}"
                            method="POST">
                            @csrf
                            ...
                            @if ($isEditMode && $driverDocument && $driverDocument->alcohol_drug_test_policy_signature)
                                <div
                                        ...
                                        <div class="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div>
                                                ...
                                                <span class="ml-2 text-blue-800 dark:text-blue-200">
                                                    {{ $driverDocument->alcohol_drug_test_policy_date ? \Carbon\Carbon::parse($driverDocument->alcohol_drug_test_policy_date)->format('m/d/Y') : 'N/A' }}
                                                </span>
                                            </div>
                                            <div>
                                                <span class="font-medium text-blue-600 dark:text-blue-400">Signature:</span>
                                                <span class="ml-2 text-blue-800 dark:text-blue-200">
                                                    {{ $driverDocument->alcohol_drug_test_policy_signature ?? 'Not Available' }}
                                                </span>
                                            </div>
                                            <div>
                                ...
                                <div class="p-5 sm:p-6">
                                    <div class="mb-8">
                                        ...
                                        <div class="p-6 border border-blue-200 rounded-lg dark:border-blue-800 mb-6">
                                            <p class="text-lg text-gray-800 dark:text-white/90 mb-4">
                                                Kindly go over the Alcohol and Drug Testing policies for the company below.
                                                Once
                                                you've completed, sign electronically to acknowledge receipt, comprehension,
                                                and
                                                agreement.
                                            </p>
                                            ...
                                            <div
                                                ...
                                                <div class="flex items-start">
                                                    ...
                                                    <p class="text-sm text-yellow-800 dark:text-yellow-300">
                                                        ...
                                                        to all
                                                        terms as set forth in the company alcohol and drug testing policy.
                                                        My
                                    ...
                                    <div class="mt-8">
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input type="text" name="employee_signature" id="employee_signature"
                                                    value="{{ old('employee_signature', $driverDocument->alcohol_drug_test_policy_signature ?? '') }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="date_signed" id="date_signed"
                                                    value="{{ old('date_signed', $driverDocument->alcohol_drug_test_policy_date ? \Carbon\Carbon::parse($driverDocument->alcohol_drug_test_policy_date)->format('Y-m-d') : date('Y-m-d')) }}"
                                                    class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                                    @if (!$isEditMode) required @endif>
                                            </div>
                                        </div>
                                        <p class="mt-4 text-sm text-gray-500 dark:text-gray-400">
                                            <i class="fas fa-info-circle mr-2"></i>
                                            By signing, you acknowledge that you have read and understood the Alcohol & Drug
                                            Testing
                                            Policy.
                                        </p>
                                    </div>
                            ...
                            <div
                                ...
                                @else
                                    <a href="{{ route('public.application.step8', ['driver_id' => $driver->id, 'slug' => $company->slug]) }}"
                                        class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-theme-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
                                        <i class="fas fa-arrow-left mr-2"></i>
                                        Back to Step 8
                                    </a>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                ...
                                @if ($driverDocument && $driverDocument->alcohol_drug_test_policy_signature)
                                    <div class="flex items-center text-sm">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hasExistingPolicyAck =
                {{ $driverDocument && $driverDocument->alcohol_drug_test_policy_signature ? 'true' : 'false' }};
            ...
            const hasExistingDate =
                {{ $driverDocument && $driverDocument->alcohol_drug_test_policy_date ? 'true' : 'false' }};

            ...
            <div class="p-4 mx-auto max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-9">
                        ...
                        <form action="{{ route('public.application.store.step4', ['slug' => $company->slug]) }}"
                                ...
                                <div class="p-5 sm:p-6">
                                    <div class="mb-6">
                                        <label class="mb-3 block text-sm font-medium text-gray-700 dark:text-gray-400">
                                            Forfeiture Document
                                            @if (!$isEditMode || !$driverDocument || !$driverDocument->forfeiture_document)
                                                <span class="text-error-500">*</span>
                                            @endif
                                        </label>

                                        @if ($driverDocument && $driverDocument->forfeiture_document)
                                            <div class="mb-4">
                                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-2">Current Forfeiture
                                                    Document:</p>
                                                @if (Str::endsWith($driverDocument->forfeiture_document, ['.jpg', '.jpeg', '.png', '.gif', '.webp']))
                                                    <div class="relative group">
                                                        <img src="{{ Storage::url($driverDocument->forfeiture_document) }}"
                                                        ...
                                                        <div
                                                            ...
                                                            <a href="{{ Storage::url($driverDocument->forfeiture_document) }}"
                                                                target="_blank"
                                                    ...
                                                    <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                        <label for="forfeiture_document"
                                                            ...
                                                            <input id="forfeiture_document" name="forfeiture_document"
                                                                ...
                                                                @if (!$isEditMode || !$driverDocument || !$driverDocument->forfeiture_document) required @endif>
                                                        </label>
                                                    </div>
                                    ...
                                    @if ($driver->forfeitures && $driver->forfeitures->isNotEmpty())
                                        <div class="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
                                            <h4 class="text-lg font-medium text-gray-800 dark:text-white/90 mb-4">
                                                Forfeiture
                                                Information</h4>
                            ...
                            <div
                                ...
                                @else
                                    <a href="{{ route('public.application.step3', ['driver_id' => $driver->id, 'slug' => $company->slug]) }}"
                                        class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-theme-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
                                        <i class="fas fa-arrow-left mr-2"></i>
                                        Back to Step 3
                                    </a>
    ...
    <script>
        ...
        form.addEventListener('submit', function(e) {
            ...
            const hasExistingDocument =
                {{ $driverDocument && $driverDocument->forfeiture_document ? 'true' : 'false' }};

...
@section('title', 'FMCSA Consent | DOT Driver Qualification Application')
            ...
            <div class="p-4 mx-auto max-w-7xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                    <div class="md:col-span-9">
                        ...
                        <form action="{{ route('public.application.store.step7', ['slug' => $company->slug]) }}"
                            method="POST">
                            @csrf
                            ...
                            @if ($isEditMode && $driverDocument && $driverDocument->fmcsa_consent)
                                <div
                                    ...
                                    <div class="p-5 sm:p-6">
                                        <div class="grid grid-cols-2 gap-4 text-sm">
                                            ...
                                            <div>
                                                <span class="font-medium text-blue-600 dark:text-blue-400">Consent
                                                    Date:</span>
                                                <span class="ml-2 text-blue-800 dark:text-blue-200">
                                                    {{ $driverDocument->fmcsa_consent_date ? \Carbon\Carbon::parse($driverDocument->fmcsa_consent_date)->format('m/d/Y H:i') : 'N/A' }}
                                                </span>
                                            </div>
                                            <div>
                                                <span class="font-medium text-blue-600 dark:text-blue-400">Signature:</span>
                                                <span class="ml-2 text-blue-800 dark:text-blue-200">
                                                    {{ $driverDocument->fmcsa_consent_signature ?? 'Not Available' }}
                                                </span>
                                            </div>
                                            <div>
                                                <span class="font-medium text-blue-600 dark:text-blue-400">Date
                                                    Signed:</span>
                                                <span class="ml-2 text-blue-800 dark:text-blue-200">
                                                    {{ $driverDocument->fmcsa_date_signed ?? 'N/A' }}
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            ...
                                            <p class="text-lg text-gray-800 dark:text-white/90 mb-4">
                                                I, <span class="font-bold">{{ $driver->first_name }}
                                                    ...
                                                    class="font-bold">{{ $company->company_name }}</span> to conduct a
                                                limited
                                                query of
                                                the FMCSA Commercial Driver's License Drug and Alcohol Clearinghouse
                                                (Clearinghouse)
                                                to determine whether drug or alcohol violation information about me exists
                                                in the
                                                Clearinghouse.
                                            </p>
                                                ...
                                                <div class="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-yellow-700 dark:text-yellow-400">
                                                            ...
                                                            {{ $company->company_name }} indicates that drug or alcohol
                                                            violation
                                                            information about me exists in the Clearinghouse, FMCSA will not
                                                            disclose that information to {{ $company->company_name }}
                                                            without
                                                            first
                                                ...
                                                <div class="flex items-start">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p class="text-sm text-red-700 dark:text-red-400">
                                                            ...
                                                            {{ $company->company_name }} to conduct a limited query of the
                                                            Clearinghouse,
                                                            {{ $company->company_name }} must prohibit me from performing
                                                            safety-sensitive
                                                            functions, including driving a commercial motor vehicle, as
                                                            required by
                                        ...
                                        <div class="mb-6">
                                            <label class="inline-flex items-start cursor-pointer select-none">
                                                ...
                                                <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">
                                                    I have read and understand the above consent statements. I voluntarily
                                                    provide
                                                    my consent for {{ $company->company_name }} to conduct multiple
                                                    unlimited
                                                    queries of
                                                    the FMCSA Drug and Alcohol Clearinghouse for the duration of my
                                                    employment.
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div>
                                                ...
                                                <input type="text" name="employee_signature" id="employee_signature"
                                                    value="{{ old('employee_signature', $driverDocument->fmcsa_consent_signature ?? '') }}"
                                            ...
                                            <div>
                                                ...
                                                <input type="date" name="date_signed" id="date_signed"
                                                    value="{{ old('date_signed', $driverDocument->fmcsa_date_signed ? \Carbon\Carbon::parse($driverDocument->fmcsa_date_signed)->format('Y-m-d') : date('Y-m-d')) }}"
                                                    class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                                    @if (!$isEditMode) required @endif>
                                            </div>
                                        </div>
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        <div class="p-4 bg-gray-50 rounded-lg dark:bg-gray-900/20">
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                                ...
                                                Agencies, and State law enforcement personnel real-time information about
                                                commercial
                                                driver's license (CDL) and commercial learner's permit (CLP) holders' drug
                                                and
                                        ...
                                        <div class="p-4 bg-gray-50 rounded-lg dark:bg-gray-900/20">
                                            ...
                                            <p class="text-sm text-gray-600 dark:text-gray-400">
                                                A check to see if there is any information in the Clearinghouse about a
                                                current or
                                                prospective driver. If a limited query returns a result of "Driver record
                                                not
                                                found," no further action is required. If it returns a result of "Requires
                                                further
                            ...
                            <div
                                ...
                                @if ($isEditMode)
                                    <a href="{{ route('admin.driver.edit', ['id' => $driver->id, 'slug' => $company->slug]) }}"
                                ...
                                @else
                                    <a href="{{ route('public.application.step6', ['driver_id' => $driver->id, 'slug' => $company->slug]) }}"
                                        class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-theme-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
                                        <i class="fas fa-arrow-left mr-2"></i>
                                        Back to Step 6
                                    </a>
                                ...
                                <div class="flex gap-4">
                                    <button type="submit" name="action" value="save"
                                        ...
                                        {{ $isEditMode ? 'Update & Continue to Step 8' : 'Save & Continue to Step 8' }}
                                    </button>
                    ...
                    <div class="md:col-span-3">
                        ...
                        <div
                            ...
                            <div class="space-y-2">
                                ...
                                @if ($driverDocument && $driverDocument->fmcsa_consent)
                                    <div class="flex items-center text-sm">
                                    ...
                                    <div class="flex items-center text-sm">
                                        ...
                                        <span class="font-medium text-gray-800 dark:text-white/90">
                                            {{ $driverDocument->fmcsa_consent_date ? \Carbon\Carbon::parse($driverDocument->fmcsa_consent_date)->format('m/d/Y') : 'N/A' }}
                                        </span>
                                    </div>
                                    <div class="flex items-center text-sm">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const hasExistingConsent =
                {{ $driverDocument && $driverDocument->fmcsa_consent ? 'true' : 'false' }};
                ...
                form.addEventListener('submit', async function(e) {
                    ...
                    if (!isEditMode) {
                        ...
                        if (!agreement.checked) {
                            showAppAlert('You must agree to the consent terms by checking the box.');
                            agreement.focus();
                            return;
                        }
            ...
            const hasExistingDate =
                {{ $driverDocument && $driverDocument->fmcsa_date_signed ? 'true' : 'false' }};

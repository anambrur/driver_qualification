...
@section('content')
    <div class="min-h-screen bg-gray-50 flex flex-col items-center p-4 md:p-8">
        <div class="w-full max-w-4xl lg:max-w-5xl xl:max-w-6xl mx-auto">
            ...
            <div class="mb-6">
                <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Driver's Application</h1>
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                <div class="md:col-span-9">
                    <form action="{{ route('public.application.store.step1', ['slug' => $company->slug]) }}" method="POST"
                            ...
                            <div class="p-5 sm:p-6">
                                <label class="flex items-center pb-4">
                                    <input type="checkbox" name="same_address" value="1" id="same_address_checkbox"
                                        ...
                                        class="text-brand-500 focus:ring-brand-500/20 dark:focus:ring-brand-800/50 h-4 w-4 border-gray-300 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900" />
                                    <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">Same address as from
                                        Applicant
                                        Information.</span>
                                </label>

                                <p class="text-sm text-gray-500 dark:text-gray-400 pb-4">List residence for previous 3
                                    years if
                                    you
                                    lived at
                        ...
                        <div
                            ...
                            <div class="p-5 sm:p-6">
                                <p class="text-sm text-gray-500 dark:text-gray-400 pb-4">List all driver licenses held
                                    within
                                    the last
                                ...
                                <div
                                    ...
                                    <p>Warning! Triple check the license information for accuracy. If you enter the wrong
                                        information,
                                        all documents relating to your license will have to be discarded and completed
                                        again.
                                        Failure to
                                    ...
                                    <div>
                                        ...
                                        <select id="license_class" name="license_class" required
                                            ...
                                            <option value="Class D"
                                                {{ old('license_class') == 'Class D' ? 'selected' : '' }}>
                                                Class D
                                            </option>
                                            ...
                                            <option value="Class M"
                                                {{ old('license_class') == 'Class M' ? 'selected' : '' }}>
                                                Class M
                                            </option>
                                            <option value="Class E"
                                                {{ old('license_class') == 'Class E' ? 'selected' : '' }}>
                                                Class E
                                            </option>
                                            <option value="Class F"
                                                {{ old('license_class') == 'Class F' ? 'selected' : '' }}>
                                                Class F
                                            </option>
                                    ...
                                    <div class="grid grid-cols-1 gap-2 sm:grid-cols-2 lg:grid-cols-3">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" name="is_p_passengers" value="1"
                                                ...
                                                class="text-brand-500 focus:ring-brand-500/20 dark:focus:ring-brand-800/50 h-4 w-4 border-gray-300 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900" />
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">P -
                                                Passengers.</span>
                                        </label>
                                        <label class="flex items-center">
                                        ...
                                        <label class="flex items-center">
                                            <input type="checkbox" name="is_s_school_bus" value="1"
                                                ...
                                                class="text-brand-500 focus:ring-brand-500/20 dark:focus:ring-brand-800/50 h-4 w-4 border-gray-300 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900" />
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">S - School
                                                Bus.</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" name="is_x_placarded_hazmat" value="1"
                                                ...
                                                class="text-brand-500 focus:ring-brand-500/20 dark:focus:ring-brand-800/50 h-4 w-4 border-gray-300 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900" />
                                            <span class="ml-2 text-sm text-gray-700 dark:text-gray-300">X - Placarded
                                                Hazmat &
                                                Tank
                                                Vehicles.</span>
                                        </label>
                                            ...
                                            <tr class="border border-gray-200 dark:border-gray-700">
                                                ...
                                                <td
                                                    ...
                                                    <select name="experience[]"
                                                        ...
                                                        <option value="yes"
                                                            {{ old('experience.' . $index) == 'yes' ? 'selected' : '' }}>
                                                            Yes
                                                        </option>
                                                    </select>
                                                </td>
                                            ...
                                            <tr class="border border-gray-200 dark:border-gray-700">
                                                ...
                                                <td
                                                    ...
                                                    <input type="text" name="offense[]"
                                                        value="{{ old('offense.0') }}" placeholder="0"
                                                        class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                                </td>
                                                <td
                                                    class="border border-gray-200 p-3 text-sm text-gray-800 dark:text-white/90">
                        ...
                        <div
                            ...
                            <div class="px-5 py-4 sm:px-6 sm:py-5 border-b border-gray-100 dark:border-gray-800">
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center gap-3 mt-2">
                                    <p class="text-sm font-medium text-gray-700 dark:text-gray-300">B. Has any license,
                                        permit
                                        or
                        ...
                        <div
                            ...
                            <div class="p-5 sm:p-6">
                                <p class="text-sm text-red-500 dark:text-red-400 pb-4">List all employers for the previous
                                    3
                                    years and
                                    ...
                                    <div
                                        ...
                                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-2">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="employer_record_city_0"
                                                    ...
                                                    value="{{ old('employer_record_city.0') }}"
                                                    class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" />
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid mt-4 grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" id="employer_record_fax_0"
                                        ...
                                        <div class="flex flex-col sm:flex-row sm:items-center gap-3 mt-2">
                                            <p class="text-sm font-medium text-gray-700 dark:text-gray-300">Was your job
                                                designated as
                                                a
                                                safety sensitive function, in any DOT regulated mode, subject to the alcohol
                                                and
                                            ...
                                            <div class="flex items-center gap-6">
                                                <!-- YES -->
                                                <label class="inline-flex items-center cursor-pointer select-none">
                                                    <input type="radio" name="safety_sensitive_function[]"
                                                        value="yes"

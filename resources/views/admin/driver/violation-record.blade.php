    ...
    <div class="p-4 mx-auto max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div class="md:col-span-9">
                ...
                <form action="{{ route('admin.driver.violation.store') }}" method="POST">
                    @csrf
                            ...
                            <div class="flex items-center gap-6">
                                <label class="inline-flex items-center cursor-pointer select-none">
                                    <input type="radio" name="violation" value="no"
                                        ...
                                        {{ $driver_document && $driver_document->violation_record_signature && (!$driver->violations || $driver->violations->isEmpty() || $driver->violations->first()->violation == 'no') ? 'checked' : '' }} />
                                    <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">I have had no
                                        violations</span>
                                </label>
                                <label class="inline-flex items-center cursor-pointer select-none">
                                    ...
                                    <span class="ml-2 text-sm font-medium text-gray-700 dark:text-gray-300">I have had
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input type="text" name="applicant_signature" id="applicant_signature"
                                            value="{{ old('applicant_signature', $driver_document->violation_record_signature ?? '') }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="date" name="date_signed" id="date_signed"
                                            value="{{ old('date_signed', $driver_document->violation_record_date_signed ?? date('Y-m-d')) }}"
                                            class="shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30"
                                            required>
                                    </div>
                                </div>
                                    ...
                                    <div class="bg-green-50 dark:bg-green-900/20 rounded-lg p-4">
                                        ...
                                        <div class="mt-2 text-sm text-green-700 dark:text-green-300">
                                            <p><strong>Signature:</strong>
                                                {{ $driver->violations->first()->violation_record_signature ?? 'N/A' }}</p>
                                                ...
                                                @foreach ($driver->violations as $violation)
                                                    @if ($violation->violation == 'yes' && $violation->violation_date)
                                                        <tr class="border-b border-gray-200 dark:border-gray-700">
                                                            <td class="p-3 text-sm text-gray-800 dark:text-white/90">
                    ...
                    <div
                        ...
                        @else
                            <a href="{{ route('admin.driver.forfeiture', ['driver_id' => $driver_id]) }}"
                                class="inline-flex items-center justify-center px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-theme-xs hover:bg-gray-50 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-brand-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700">
                                <i class="fas fa-arrow-left mr-2"></i>
                                Back to Step 4
                            </a>
            ...
            <div class="md:col-span-3">
                ...
                <div class="mt-6 rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-white/[0.03] p-4">
                    ...
                    <div class="space-y-2">
                        ...
                        @endif
                        @if ($driver_document && $driver_document->violation_record_signature)
                            <div class="flex items-center text-sm">
                                <span class="w-24 text-gray-500 dark:text-gray-400">Last Signed:</span>
                                <span class="font-medium text-gray-800 dark:text-white/90">
                                    {{ $driver_document->violation_record_date_signed ? \Carbon\Carbon::parse($driver_document->violation_record_date_signed)->format('m/d/Y') : 'N/A' }}
                                </span>
                            </div>
                        @endif
                    </div>

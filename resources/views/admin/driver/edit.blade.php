                ...
                <form action="{{ route('admin.driver.update', $driver->id) }}" method="POST" id="driverForm"
                    ...
                    <div class="mb-4 md:hidden rounded-xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
                        ...
                        <select id="driver-section-jump-mobile"
                            ...
                            <option value="section-company">Company</option>
                        ...
                        <div class="p-5 sm:p-6">
                            ...
                            @else
                                <input type="hidden" name="company_id"
                                    value="{{ old('company_id', $companies->first()->id ?? $driver->company_id ?? '') }}">
                                <div
                                    ...
                                    <p class="font-medium text-gray-800 dark:text-white/90">
                                        {{ $companies->first()->company_name ?? $driver->company->company_name ?? 'Your company' }}
                                    </p>
                                </div>
                            @endif
                        </div>
                    ...
                    <div
                        ...
                        <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                            <p class="text-xs text-gray-500 dark:text-gray-400">Save changes and continue to license
                                documents.</p>

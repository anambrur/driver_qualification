...
@section('content')
    <div class="p-4 mx-auto max-w-7xl">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Company's General Work Policy</h1>
            <p class="text-gray-600 dark:text-gray-400">Company's General Work Policy</p>
        </div>
                            ...
                            <div class="mb-8">
                                ...
                                <div class="p-6 border border-blue-200 rounded-lg dark:border-blue-800 mb-6">
                                    <p class="text-lg text-gray-800 dark:text-white/90 mb-4">
                                        ...
                                        electronically to acknowledge
                                        the receipt, comprehension, and agreement. You will receive a copy of the policy
                                        once you have completed the
                                        online application. You can also save a copy of the policy right now by hitting the
                                        Download icon in the
                                        viewer's top right corner.
                                    </p>
                                </div>
                                ...
                                <div class="mb-6">
                                    ...
                                    <p class="">I have read, fully understand and agree to al terms as set forth in
                                        the company general work policy.</p>
                                </div>
                            </div>

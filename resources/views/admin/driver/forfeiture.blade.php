...
@section('content')
    <div class="p-4 mx-auto max-w-7xl">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-800 dark:text-white/90">Upload Forfeiture Document</h1>
            <p class="text-gray-600 dark:text-gray-400">Upload images of the driver's forfeiture document</p>
        </div>
                                        ...
                                        <div class="flex flex-col items-center justify-center">
                                            ...
                                            <div class="flex text-sm text-gray-600 dark:text-gray-400">
                                                <label for="forfeiture_document"
                                                    ...
                                                    <span>Upload Forfeiture Document</span>
                                                    <input id="forfeiture_document" name="forfeiture_document" type="file"
...
@push('scripts')
    <script>
        ...
        form.addEventListener('submit', function(e) {
            const medicalCard = document.getElementById('forfeiture_document');

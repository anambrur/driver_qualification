                ...
                <div class="p-5 sm:p-6">
                    ...
                    <div class="mb-6">
                        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
                            <div>
                                <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300">Filter by Status</h4>
                                <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Click to filter drivers by status
                                </p>
                            </div>
                        ...
                        <div class="flex flex-wrap gap-2 items-center justify-center">
                            <!-- All Status -->
                            <button type="button"
                                class="status-filter inline-flex items-center rounded-full px-4 py-2 text-sm font-medium transition-all border border-brand-500 bg-brand-50 text-brand-700 dark:border-brand-500 dark:bg-brand-900/20 dark:text-brand-300"
                                data-status="all">
                                <span class="mr-2">All Drivers</span>
                                <span
                                    class="inline-flex items-center justify-center min-w-6 h-6 rounded-full bg-gray-100 text-xs text-gray-600 dark:bg-gray-700 dark:text-gray-400"
                                    id="count-all">{{ $statusCounts['all'] ?? 0 }}</span>
                            </button>

                            <!-- Pending -->
                            <button type="button"
                                class="status-filter inline-flex items-center rounded-full px-4 py-2 text-sm font-medium transition-all border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300 dark:hover:bg-gray-700"
                                data-status="pending">
                                <span class="mr-2 flex items-center">
                                    Pending
                                </span>
                                <span
                                    class="inline-flex items-center justify-center min-w-6 h-6 rounded-full bg-yellow-100 text-xs text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-400"
                                    id="count-pending">{{ $statusCounts['pending'] ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <span
                                    class="inline-flex items-center justify-center min-w-6 h-6 rounded-full bg-green-100 text-xs text-green-700 dark:bg-green-900/30 dark:text-green-400"
                                    id="count-active">{{ $statusCounts['active'] ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <span
                                    class="inline-flex items-center justify-center min-w-6 h-6 rounded-full bg-red-100 text-xs text-red-700 dark:bg-red-900/30 dark:text-red-400"
                                    id="count-inactive">{{ $statusCounts['inactive'] ?? 0 }}</span>
                            </button>
                            ...
                            <button type="button"
                                ...
                                <span
                                    class="inline-flex items-center justify-center min-w-6 h-6 rounded-full bg-gray-100 text-xs text-gray-700 dark:bg-gray-700 dark:text-gray-400"
                                    id="count-rejected">{{ $statusCounts['rejected'] ?? 0 }}</span>
                            </button>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('.status-filter').on('click', function() {
                ...
                $('.status-filter').removeClass(
                    'active border-brand-500 bg-brand-50 text-brand-700 dark:border-brand-500 dark:bg-brand-900/20 dark:text-brand-300'
                );
                $('.status-filter').addClass(
            ...
            $('#clear-filters').on('click', function() {
                ...
                // Activate "All Drivers" button
                $('.status-filter[data-status="all"]').removeClass(
                    'border-gray-300 bg-white text-gray-700 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-300'
                );
                $('.status-filter[data-status="all"]').addClass(
                    'active border-brand-500 bg-brand-50 text-brand-700 dark:border-brand-500 dark:bg-brand-900/20 dark:text-brand-300'
                );
                ...
                try {
                    ...
                    table = $('#drivers-table').DataTable({
                        ...
                        ajax: {
                            ...
                            type: 'GET',
                            data: function(d) {
                                // Add status parameter to AJAX request

    ...
    <div class="p-4 mx-auto max-w-7xl md:p-6">
        ...
        <div class="mb-6">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800 dark:text-white/90">Edit Role: {{ $role['name'] }}</h2>
                    <p class="text-gray-600 dark:text-gray-400 mt-2">Update role details and permissions</p>
                </div>
                        ...
                        <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                            ...
                            <div>
                                ...
                                <input type="text" id="name" name="name" required
                                    ...
                                    placeholder="e.g., Content Manager, Editor" value="{{ old('name', $role['name']) }}" />
                                @error('name')
